            ...
            return (
              <div key={stat.id} className="stat-item flex items-center border-b border-[#c22026] pb-5 opacity-0">
                ...
                <div className="w-[140px] md:w-[180px] flex items-start shrink-0">
                  <span className="text-[36px] md:text-[44px] font-medium text-[#c22026] leading-none flex items-start -mt-1">
                    {stat.prefix && (
                ...
                <div className="flex-1 flex items-center pr-4">
                  <span className="text-[17px] md:text-[19px] font-normal text-black leading-snug">
                    {stat.label}
                  </span>
                </div>
              </div>
