  ...
  return (
    <section ref={containerRef} className="py-20 md:py-28 bg-white w-full font-sans">
      <div className="max-w-[1440px] mx-auto px-8 md:px-14">
        <h2 className="testimonial-header opacity-0 text-[32px] md:text-[36px] text-[#c22026] font-light tracking-wide mb-12 uppercase">
          Client Testimonials
        </h2>
          ...
          {TESTIMONIALS.map((testimonial) => {
            ...
            return (
              <div key={testimonial.id} className="testimonial-item opacity-0 border-b border-gray-100">
                ...
                >
                  <span className="text-[17px] md:text-[18px] font-light text-[#222] pr-8">
                    {testimonial.name}
                  </span>
                    ...
                    >
                      <div className="pb-10 pt-4 pr-4 md:pr-12 pl-[18px]">
                        <div className="border-l-[3px] border-[#c22026] pl-5 md:pl-7 py-1">
                          <p className="text-[15px] md:text-[16px] text-black italic leading-loose font-medium">
                            "{testimonial.quote}"
                          </p>
                        </div>
                      </div>
