...
const copyByLocale: Record<'en' | 'fr', CinematicCopy> = {
  ...
  en: {
    ...
    body: 'Inside, circulation runs around a central staircase while the pyramidal glass skylight lights the retail levels below. Both interiors were finished by Igloo as part of the secondary works — finishes, technical networks, and the details in between.',
    ...
    panelPoints: [
      ...
      'Natural light for the retail levels beneath',
    ],
    beforeLabel: 'Before',
    afterLabel: 'After',
  },
  fr: {
    eyebrow: 'Rahmania / Douira',
    title: "Commerces, services et vie quotidienne reunis au coeur d'un quartier en croissance.",
    titleLines: [
      [{ text: 'Commerces, services et' }],
      [{ text: 'vie quotidienne reunis au' }],
      [{ text: 'au ' }, { text: 'coeur', accent: true }],
      [{ text: "d'un quartier en croissance." }],
    ],
    body: 'A l interieur, la circulation s articule autour d un escalier central tandis que la verriere pyramidale eclaire les niveaux commerciaux. Les interieurs ont ete acheves par Igloo au titre des corps d etat secondaires — finitions, reseaux techniques et tous les details entre les deux.',
    panelEyebrow: 'Avant / Apres',
    panelTitle: 'La pyramide de verre',
    panelBody: 'L element distinctif du projet : une verriere pyramidale en verre couronnant l atrium central. D abord esquissee comme une simple etude de volume, elle a ete executee en structure vitree qui diffuse la lumiere naturelle sur les niveaux commerciaux et l escalier central.',
    panelPoints: [
      'Esquissee comme etude de volume sur l atrium central',
      'Executee par Igloo dans le cadre des corps d etat secondaires',
      'Lumiere naturelle pour les niveaux commerciaux en dessous',
    ],
    beforeLabel: 'Avant',
    afterLabel: 'Apres',
  },
