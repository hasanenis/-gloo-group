...
function getChannels(t: Translate): Channel[] {
  return [
    ...
    { label: t('contactInternationalLabel'), value: companyProfile.phones[1], href: `tel:${companyProfile.phones[1].replace(/\s/g, '')}`, detail: t('contactInternationalDetail'), icon: Phone },
  ];
}
