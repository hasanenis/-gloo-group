...
- Name: site-qa.spec.ts >> layout snapshot: bat-demo @ 1440x900
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  3015 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: bat-demo-1440x900.png

Call log:
  - Expect "toHaveScreenshot(bat-demo-1440x900.png)" with timeout 15000ms
