...
- Name: site-qa.spec.ts >> layout snapshot: bat-demo @ 1920x1080
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  9011 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: bat-demo-1920x1080.png

Call log:
  - Expect "toHaveScreenshot(bat-demo-1920x1080.png)" with timeout 15000ms
