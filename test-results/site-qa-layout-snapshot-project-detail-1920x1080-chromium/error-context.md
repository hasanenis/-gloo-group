...
- Name: site-qa.spec.ts >> layout snapshot: project-detail @ 1920x1080
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  952132 pixels (ratio 0.46 of all image pixels) are different.

  Snapshot: project-detail-1920x1080.png

Call log:
  - Expect "toHaveScreenshot(project-detail-1920x1080.png)" with timeout 15000ms
