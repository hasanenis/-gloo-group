...
- Name: site-qa.spec.ts >> layout snapshot: projects @ 1920x1080
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  951671 pixels (ratio 0.46 of all image pixels) are different.

  Snapshot: projects-1920x1080.png

Call log:
  - Expect "toHaveScreenshot(projects-1920x1080.png)" with timeout 15000ms
    - verifying given screenshot expectation
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 808187 pixels (ratio 0.39 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 182702 pixels (ratio 0.09 of all image pixels) are different.
